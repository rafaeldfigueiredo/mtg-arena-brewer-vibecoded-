...
console.log("🚀 Initializing Safe Cloud Next.js Historic Brawl Builder Setup...");
...
// ==========================================
const packageJson = {
  "name": "historic-brawl-brewmaster-next",
  "version": "1.0.0",
  "private": true,
  "scripts": {
    "dev": "next dev",
...
// Create Next.js expected system folder layouts
ensureDir(path.join(ROOT_DIR, 'pages', 'api'));

// ==========================================
// 2. THE PRIVATE BACKEND ROUTE (pages/api/brew.js)
// ==========================================
const apiBrewRouteContent = `
...
`;
writeFile(path.join(ROOT_DIR, 'pages', 'api', 'brew.js'), apiBrewRouteContent);

// ==========================================
// 3. THE FRONTEND UI USER DASHBOARD (pages/index.js)
// ==========================================
...
`;
writeFile(path.join(ROOT_DIR, 'pages', 'index.js'), frontendContent);

// ==========================================
// 4. DOWNLOAD DEPENDENCIES AUTOMATICALLY
// ==========================================
console.log("\n📦 Setting up project local structures and executing automated npm installations...");
try {
    execSync('npm install', { stdio: 'inherit' });
    console.log("\n✨ Unified setup complete!");
    console.log("👉 To work on this app locally, run: npm run dev");
} catch (e) {
    console.log("\n⚠️ Code files created successfully, but automatic installation ran into a snag. Run 'npm install' inside this directory to finalize.");
}